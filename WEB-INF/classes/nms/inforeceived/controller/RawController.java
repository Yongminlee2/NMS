...
import nms.inforeceived.service.RawService;
import nms.inforeceived.vo.RawListVO;
...
@Controller
@RequestMapping("/inforeceived/raw")
public class RawController {
	...
	{
		return "/inforeceived/raw";
	}
	
	@RequestMapping("/getRawList.ws")
	public @ResponseBody ResponseDataListVO getRawList(@RequestBody Map<String, String> sch_data, HttpServletRequest request)throws Exception
	{
		...
		List<List<Object>> results = rawService.getRawList(date_s, date_e, obs_kind, sta_type, page);
		
		if(results != null && results.size() != 0)
		{
			List<RawListVO> list = getDataset(results, 0);
