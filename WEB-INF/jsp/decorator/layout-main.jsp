...
// 					$("#userInfo .g2").html("!");
	...
	<body class="mBg" onload="pageAccessSetting()">
		<div id="wrap">
			<section class="topGnb">
				<!--상단 메뉴-->
				<h1 class="logo"><a href="<c:url value="/"/>">한국수력원자력</a></h1>
				<ul class="gnb" id="userInfo">
					<li class="g1"><a href="<c:url value="/login"/>">로그인</a></li>
<%-- 					<li class="g2"><a href="<c:url value="/system/observatory/list"/>">정보수정</a></li> --%>
					<li class="g4" style="display:none;"><a href="<c:url value="j_spring_security_logout" />">로그아웃</a></li>
				</ul>
			</section>
			<!--## top menu ##-->
			<div id="gnb">
