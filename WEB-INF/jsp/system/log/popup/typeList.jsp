	...
	<script>
		...
		*/
		...
		function fnSaveSubAttribute(form)
		{
			...
			var jsonStr = formSerializeToJsonStr("log-type-table","table");
			url = "${pageContext.request.contextPath}/system/log/insertLogType.ws";
		...
		{
			url = "${pageContext.request.contextPath}/system/log/deleteLogType.ws";
			if(confirm("삭제하시겠습니까?")){
...
<%-- 			     <h2>${stationInfo.obs_name } 관측소</h2> --%>
	<!-- 				            표2 -->
			 <span style="float:right;margin-right:26px;"><a href="#"><img src="<c:url value="/img/btt_hadd.png"/>" onclick="fnAddDataRow('log-type-table')" alt="목록"></a> <a href="#"  onclick="fnSaveSubAttribute('log-type-table')"><img src="<c:url value="/img/btt_save.png"/>" alt="목록"></a></span>
	              ...
	              <table>
	                ...
	                <tbody id="log-type-table">
	                  ...
	                  <c:forEach items="${typeList }" var="tl">
		              	<tr>
		              		<td type="input" chk="true"><input type="hidden" name="l_no" value="${tl.l_no }"></td>
		                    <td type="input" chk="true"><input onKeyup="fnChangeValue(this)" type="text" name="l_type" value="${tl.l_type }"></td>
							<td type="input" chk="true"><input onKeyup="fnChangeValue(this)" type="text" name="l_name" value="${tl.l_name }"></td>
							<td child="delete" style="width:40px;"><a href="#"><img src="<c:url value="/img/btt_dele.png"/>" onclick="fnDeleteSubList('${tl.l_no}',this)" alt="목록"></a></td>
	                	</tr>
	                  </c:forEach>
	                </tbody>
	              </table>
