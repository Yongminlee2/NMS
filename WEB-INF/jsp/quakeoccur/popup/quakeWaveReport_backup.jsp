...
// 			var top_data = fnCalTopToPopupWave(Number(37.566667));
// 			var left_data = fnCalleftToPopupWave(Number(126.978056));
// 			var top_data = fnCalTopToPopupWave(Number(35.53889));
// 			var left_data = fnCalleftToPopupWave(Number(129.31667));
		...
		function test(){
			...
			html2canvas($('.map_type_wide'), {
                onrendered: function(canvas) {
                    ...
                    $(".map_type_wide").css("margin-top","55px");
                    $("#map_layout").css("top","383px");
                    $("#imgData").val(image);
                }
            });		
...
<!-- 	<div style="width:50px;height:50px;position: absolute;top:200px;left:50%;background-color:black;"></div> -->
	<div class="popup-tap-wrap">
		<ul class="tabs">
			<li id="menu1" rel="simple-report-tab" class="active">요약보고서</li>
			<li id="menu2" rel="wave-report-tab">관측파형</li>
			<li id="menu3" rel="wave-report2-tab">관측파형2</li>
		</ul>
		<div id="pop_wrap">
				...
				<section class="pop_body">
					...
					<article class="pop_table">
						<article class="map_type_wide" style="float:left;width:394px;height:410px;overflow: hide;margin-top:55px;">
							<div id="map_layout" style="display: block;position: absolute;top:383px;left:35px;width:394px;height:410px;"></div>
							<br/>
							<br/>
							<br/>
							<br/>
