		...
		<div class="popup-info-container">
			<div id="simple-report-tab" class="tab-contrainer">
				<section class="pop_body">
					<h2>1. 개요</h2><div style="display: block;position: absolute;top:10px;right:20px;cursor: pointer;" onclick="test()"><img src="<c:url value="/img/btt_exell_down.png"/>"></div>
					...
					<article class="pop_table">
						<article class="map_type_wide" style="float:left;width:250px;height:199px;overflow: hide;margin-top:7px;">
