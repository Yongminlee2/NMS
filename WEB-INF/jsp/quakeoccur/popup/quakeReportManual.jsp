...
// 			$("#wave2_img").attr("src","/customImgPath/data/HSGEO/remoteseg/manual/${org_type}/imgTT/${org_type}_distance_time_graph.png");
			$(".popup-info-container div:first").show();
			$("#mainArea").html('${mainData.area}' + ' 지역');
			$("#txt").html('코멘트 :'+' ${mainData.comment}'+'<br> 특이사항 :'+' ${mainData.etc}');
			$("#txt2").html('보고자 :'+' ${mainData.uInfo}');
			if('${viewTap}'=="y"){
				$(".tabs li").hide();
			}
...
// 			}
		...
		function getWaveGraphData(type){
			...
			function(response){
				...
				var graphTdTitle = "";
				var cnt = 0;
				var type = response.data[0].station_type;
				if(type=="NC"){
...
// 		function fnSetMapIcon2(mapLayout, left_data,top_data, obs_type, color)
// 		{
// 			mapLayout.innerHTML = mapLayout.innerHTML + "<ul id='mapUl' style='position: absolute;'><li style='position: relative;'><div id ='"+obs_type+color+"' sta_id ='"+left_data+"' style ='border-radius:100px;display:block;width:15px;height:15px;background-color:"+color+";-webkit-transform:translate("+left_data+"px,"+top_data+"px); -ms-transform:translate("+left_data+"px,"+top_data+"px); transform:translate("+left_data+"px,"+top_data+"px);'></div></li></ul>"; 
// 		}				
...
<form class="search-form" name="searchForm" method="post" autocomplete="off" enctype="multipart/form-data">
	...
	<input type="hidden" id="f_no" name="no" value='manual'/>
	<input type="hidden" id="f_type" name="type" value='${org_type }'/>
...
<!-- 			<li id="menu5" rel="wave-report2-tab">파형 분석</li> -->
	    ...
	    <div id="txt" style="position:absolute;left:20px;"></div>
	    <div id="txt2" style="position:absolute;right:25px;padding-top:12px;color:red;font-weight: bold;"></div>
...
<!-- 			원전 -->
			...
			<div id="simple-report-tab" class="tab-contrainer">
				<section class="pop_body">
					...
					<article class="pop_table">
						<article class="" style="float:left;width:250px;height:230px;overflow: hide;margin-top:7px; background-image: url('/customImgPath/var/www/html/mkOriginArea/manual.jpg'); background-size:325px; background-position:top;">
...
<!-- 								<th>ID</th> -->
			...
			<div id="simple-report3-tab" class="tab-contrainer">
				<section class="pop_body">
					...
					<span style="float:right;margin-right:25px;">(1g=980cm/sec²=980gal, SSE=0.2g, OBE=0.1g)</span>
						<article class="pop_table">
						<article style="float:left;width:250px;height:230px;overflow: hide;margin-top:7px; background-image: url('/customImgPath/var/www/html/mkOriginArea/manual.jpg'); background-size:325px; background-position:top;">
...
<!-- 								<th>ID</th> -->
			...
			<div id="wave-report-tab" class="tab-contrainer">
				<section class="pop_body">
					...
					<h2>2. 지진 분포도</h2>
					<article class="map_type4" style="height:658px;width:561px;margin:0 auto;">
						<div id="map_layout4" style="display: block;position: absolute;top:423px;left:144px;width:560px;height:658px;"></div>
						<br/>
						<br/>
						<br/>
						<br/>
